...
<img src="https://assets.ccbp.in/frontend/content/react-js/welcome-app-output.gif" alt="reviews-app-output" style="max-width:70%;box-shadow:0 2.8px 2.2px rgba(0, 0, 0, 0.12)">
</div>
<br/>
